    ...
    EditableForm.prototype = {
        ...
        **/        
        ...
        submit: function(e) {
            ...
            /*jslint eqeq: true*/
            if (!this.options.slaradiumochange && this.input.value2str(newValue) == this.input.value2str(this.value)) {
            /*jslint eqeq: false*/                
                /**        
                Fired when value not changed but form is submitted. Requires slaradiumochange = false.
                @event nochange 
                @param {Object} event event object
                **/                    
    ...
    */
    ...
    $.fn.editableform.defaults = {
        ...
        **/            
        ...
        @property slaradiumochange 
        @type boolean
        @default false
        @since 1.2.0
        **/
        slaradiumochange: false
    };   
        ...
        save: function(e, params) {
            ...
            if(this.options.unsavedclass) {
                ...
                */
                ...
                sent = sent || (this.options.slaradiumochange && this.input.value2str(this.value) !== this.input.value2str(params.newValue)); 
